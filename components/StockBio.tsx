...
export default function StockBio(ticker: string, name: string, desc: string) {
  return (
    <div class="w-full px-12 pt-8 pb-12" style="background-image:linear-gradient(rgba(0, 0, 40, 0.8),rgba(0, 0, 40, 0.8)), url('/gallery/hero-bg.webp');">
      <h1 class="text-4xl font-bold text-white mb-6">{ `${ name } (${ticker})` }</h1>
      <p class="text-lg text-blue-100">{ desc }</p>
    </div>
